...
pub struct Attack {
    ...
    #[serde(rename = "shot_speed", skip_serializing_if = "Option::is_none")]
    ...
    pub pellet: Option<Box<models::AttackPellet>>,
    ...
    pub falloff: Option<Box<models::AttackFalloff>>,
    #[serde(rename = "damage", skip_serializing_if = "Option::is_none")]
    pub damage: Option<Box<models::Damage>>,
    ...
    pub slam: Option<Box<models::SlamAttack>>,
}
