...
pub struct ArchonHunt {
    ...
    pub missions: Vec<models::Mission>,
    #[serde(rename = "boss")]
    pub boss: String,
    /// Faction of the boss controlling the archon hunt
    #[serde(rename = "faction")]
    pub faction: models::Faction,
    /// Unlocalized Faction of the boss controlling the archon hunt
    #[serde(rename = "factionKey", skip_serializing_if = "Option::is_none")]
    pub faction_key: Option<models::Faction>,
}

impl ArchonHunt {
    pub fn new(reward_pool: String, missions: Vec<models::Mission>, boss: String, faction: models::Faction) -> ArchonHunt {
        ArchonHunt {
            id: None,
            activation: None,
            expiry: None,
