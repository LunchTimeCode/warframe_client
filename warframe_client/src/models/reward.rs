...
impl Reward {
    pub fn new(counted_items: Vec<models::RewardCountedItemsInner>, thumbnail: String, color: f64, credits: i32, as_string: String, items: Vec<String>, item_string: String) -> Reward {
        Reward {
            counted_items,
            thumbnail,
            color,
