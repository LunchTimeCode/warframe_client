...
pub struct InvasionAllOfAttackerReward {
...
impl InvasionAllOfAttackerReward {
    pub fn new(counted_items: Vec<models::RewardCountedItemsInner>, thumbnail: String, color: f64, credits: i32, as_string: String, items: Vec<String>, item_string: String) -> InvasionAllOfAttackerReward {
